...
#git clone https://github.com/marchmin/lede-cups.git package/printing
...
echo "src-git printing-packages https://github.com/master-0123/openwrt-printing-packages.git" >> feeds.conf.default
